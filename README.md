...
一个让 Mac 持续工作的菜单栏小工具，适合长任务、远程连接、下载和演示场景。

## 下载

[下载 NoSleep.dmg](https://github.com/xmuhhh/noSleep/raw/main/dist/NoSleep.dmg)

## 功能

- 防止 Mac 因闲置进入休眠。
- 支持合盖后继续工作，让 Codex 等后台任务在 MacBook 合盖后继续运行。
- 退出 NoSleep 时，恢复应用启动前的休眠状态。
- 菜单栏只显示状态图标。
- 下拉菜单采用三态选择：正常休眠、持续工作、合盖继续工作。
